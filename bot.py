...
from DreamXbotz.storage import prepare_storage, close_storage
...
async def SilentXBotz_start():
    ...
    LOGGER.info("Initializing Your Combined Auto-Filter & Auto-Caption Bot!")
    
    try:
        await prepare_storage()
        LOGGER.info("✅ Auto-Caption Storage Initialized.")
    except Exception as e:
        LOGGER.error(f"Error initializing Auto-Caption storage: {e}")
